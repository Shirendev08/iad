                   ...
                   <div className='flex flex-row mb-10'>
                        ...
                        <div className='bg-white p-10'>
                            ...
                            <ul className='list-disc list-inside dark:text-gray-400 bg-white mb-5 p-10'>
                                <li>Харилцагчийн гарын үсгийг программд оруулаагүй,</li>
                                <li>Харилцагчийн зургийг программд оруулаагүй,</li>
                                <li>Харилцах, хадгаламжийн дансны гарын үсгийг программд оруулаагүй, холбоогүй.</li>
                        ...
                        <p className='bg-white mb-10 h-10 w-full flex justify-center text-center'>
                        Иймд салбарын зүгээс дараах алдаануудыг давтахгүй байхад анхааран ажиллахыг зөвлөж байна.
                    </p>
