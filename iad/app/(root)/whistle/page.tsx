      ...
      <div className="flex justify-center sm:px-16 px-4">
        <div className="max-w-5xl w-full">
          ...
          <form onSubmit={handleFormSubmit} className="mr-1">
            ...
            <button
              type="submit"
              className="text-white mt-5 bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
            >
              Илгээх
            </button>
          </form>
