...
const Page = () => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setFormData((prevData) => ({
      ...prevData,
      [id]: type === "file" && files ? files[0] : value,
    }));
  };
      ...
      <div className="flex justify-center sm:px-16 px-4">
        <div className="max-w-5xl w-full">
          ...
          <form onSubmit={handleFormSubmit} className="mr-1">
            ...
            <button
              type="submit"
              className="text-white mt-5 bg-green-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Илгээх
            </button>
          </form>
